window.addEventListener("load", function () {
  ...
  class Game {
    constructor(canvas) {
      ...
      // Event listeners
      window.addEventListener("mousedown", (elvis) => {
        this.mouse.x = elvis.offsetX;
        this.mouse.y = elvis.offsetY;
        this.mouse.pressed = true;
      });
      window.addEventListener("mouseup", (elvis) => {
        this.mouse.x = elvis.offsetX;
        this.mouse.y = elvis.offsetY;
        this.mouse.pressed = false;
      });
      window.addEventListener("mousemove", (elvis) => {
